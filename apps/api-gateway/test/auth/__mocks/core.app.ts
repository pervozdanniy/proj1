...
import { UserController } from '~svc/core/src/api/user/controllers/user.controller';
...
import { UserContactService } from '~svc/core/src/api/user/services/user-contact.service';
