...
export class AlterBalanceTable1677138110571 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "prime_trust_balance" ADD "non_contingent_hold" double precision NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "prime_trust_balance" ADD "contingent_hold" double precision NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "prime_trust_balance" ADD "pending_transfer" double precision NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "prime_trust_balance" ADD "disbursable" double precision NOT NULL DEFAULT '0'`,
    );
  }
}
